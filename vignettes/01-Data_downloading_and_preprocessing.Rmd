---
title: "01. Data downloading and preprocessing"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{01. Data downloading and preprocessing}
...
Before importing the data in an R session, we need to define a dictionary to standardize units of variables to the `climate4R` vocabulary (check `climate4R.UDG::C4R.vocabulary()`).
